...
Release of the library according to the new publication []().

### Added

- :computer: [Python] Geometry submodule for the computation of the shape area (ref. `deepskin/geometry.py`)
- :closed_book: [Docs] Example of the wound area estimation

### Update

- :computer: [Python] Add new version of the semantic segmentation for the identification of the reference marker
- :closed_book: [Docs] Update the old notebooks according to the new semantic segmentation model
- :globe_with_meridians: [Global] Update online model checkpoint
